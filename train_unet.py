...
def main():
    ...
    parser.add_argument('-data_dir', default='C:\\Users\\real\\Downloads\\crack_segmentation_dataset', type=str, help='input dataset directory')
    parser.add_argument('-model_dir', default='.\\', type=str, help='output dataset directory')
